  ...
  return (
    ...
    >
      <div className="border border-dark-03 p-3 relative w-full md:w-2/5 lg:w-1/2 mr-12 ml-5 md:mr-0">
        <img src="/assets/luxery.webp" alt="" />
        <div className="absolute -bottom-10 -right-10 w-56 md:w-60 lg:w-80 p-3 bg-white">
          <img src="/assets/jpg.webp" alt="" />
        </div>
      </div>
      <div className="w-full md:w-3/5 lg:w-1/2 mt-6">
        <h3 className="text-dark-03 tracking-[5px] mb-3">WELCOME TO HOTELHUB</h3>
        ...
        <p className="text-dark-02 mb-8">
          {"We're"} your go-to destination for effortless hotel bookings. Explore top
          accommodations, unlock exclusive deals, and start your journey with us today. Your perfect
        ...
        <div className="flex flex-wrap gap-6 md:gap-2 justify-between items-center mb-5 flex-col md:flex-row">
          <div className="flex gap-4 items-center">
            ...
            <div>
              <h4 className=" text-dark-01 font-medium mb-1">20 Years of Experience</h4>
              <p className="text-dark-02 text-sm">Elevating Standards Innovation.</p>
            </div>
          </div>
          <div className="flex gap-4 items-center">
            ...
            <div>
              <h4 className=" text-dark-01 font-medium mb-1">180+ Destinations</h4>
              <p className="text-dark-02 text-sm">Elevating Standards Innovation.</p>
            </div>
          </div>
        </div>
