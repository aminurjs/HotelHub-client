...
const Banner = () => {
  ...
  return (
    <div className="bg-[url(/assets/luxury-hotel-resort.jpg)] bg-fixed bg-cover bg-center">
      <div className="bg-gradient-to-r from-dark-01">
        <div className="bg-dark-01 bg-opacity-30 py-20 md:py-36">
          ...
          >
            <h2 className="text-lg md:text-2xl text-white  font-medium  mb-4">Unwind in Style:</h2>
            ...
            <p className="text-sm md:text-lg text-gray-100 mx-auto max-w-3xl mb-4">
              At HotelHub, we redefine luxury with personalized service and unparalleled attention
              to detail. Immerse yourself in a world of indulgence, whether {"you're"} traveling for
              business or pleasure. Your comfort and satisfaction are our top priorities.
            </p>
            <h2 className=" text-white  font-medium  mb-8">Explore. Book. Experience.</h2>
            <div>
              <Link to={"/rooms"}>
