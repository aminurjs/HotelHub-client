...
const Offers = () => {
  return (
    <div className="max-w-7xl mx-auto py-20 grid grid-cols-3 gap-6">
      <div className="py-10">
      ...
      <div className=" bg-[url(https://i.ibb.co/g78VMx5/leisure-beautiful-health-garden-landscape.jpg)] bg-cover bg-center bg-no-repeat mx-10 p-5 flex items-end">
      ...
      <div className=" bg-[url(https://i.ibb.co/hHMpV3d/outdoor.png)] bg-cover bg-no-repeat mx-10 p-5 flex items-end">
        <div className="bg-white p-4 rounded flex justify-between items-end w-full">
          <div>
            <h1 className="text-2xl text-dark-03 font-semibold mb-2">
              25% off
